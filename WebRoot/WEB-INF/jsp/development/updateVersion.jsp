...
<title>My JSP 'updateVersion.jsp' starting page</title>
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="x_panel">
					<div class="x_title">
						<h2>
							修改APP最新版本信息 <i class="fa fa-user"></i><small>${devUser.devName}</small>
						</h2>
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left"
								action="${pageContext.request.contextPath }/app/updateVersion" method="post"
								enctype="multipart/form-data">
								<input type="hidden" name="id" id="id" value="${appInfo.versionList.get(0).id}">
								<input type="hidden" name="appId" id="appId"
									value="${appInfo.versionList.get(0).appId}">
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12"
										for="name">版本号 <span class="required">*</span> </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input class="form-control col-md-7 col-xs-12"
											value="${appInfo.versionList.get(0).versionNo }" type="text"
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="number" id="versionSize" name="versionSize"
											value="${appInfo.versionList.get(0).versionSize }" required="required"
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="hidden" name="publishStatus" id="publishStatus"
											value="${appInfo.versionList.get(0).publishStatus}">${appInfo.versionList.get(0).publishStatusString}
									</div>
								</div>
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<textarea id="versionInfo" name="versionInfo"
											...
											class="form-control col-md-7 col-xs-12">${appInfo.versionList.get(0).versionInfo}</textarea>
									</div>
								</div>
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12"
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="hidden" id="downloadLink"
											value="${appInfo.versionList.get(0).downloadLink}" /> <input type="hidden"
											id="apkLocPath" 
											value="${appInfo.versionList.get(0).apkLocPath}" /> <input type="hidden"
											id="apkFileName"
											value="${appInfo.versionList.get(0).apkFileName}" />
